        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
            ...
            <div className="max-w-4xl mx-auto space-y-6 text-lg leading-relaxed text-vitisanus-purple">
              <p>
                La Harina de Uva Vitisanus es un producto innovador obtenido a partir del orujo de uva, el residuo
                sólido que queda después del prensado en la elaboración del vino. A través de un cuidadoso proceso de
                secado y molienda, transformamos este subproducto del viñedo en una harina nutritiva y versátil.
              </p>
              <p>
                Rica en antioxidantes naturales y fibra, nuestra harina aporta un distintivo color morado y un sabor
                suave que enriquece tus preparaciones culinarias, desde panificados hasta smoothies y salsas.
              </p>
            </div>
          </div>
          ...
          <div className="mb-16">
            <h3 className="font-chunk text-2xl text-vitisanus-purple text-center mb-8">Del Viñedo a tu Mesa</h3>
            <div className="flex flex-col md:flex-row items-center justify-center space-y-8 md:space-y-0 md:space-x-8 max-w-4xl mx-auto">
              <div className="flex flex-col items-center text-center">
                <div className="w-20 h-20 bg-vitisanus-light-purple rounded-full flex items-center justify-center mb-4">
                  <svg xmlns="http://www.w3.org/2000/svg" className="w-10 h-10 text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round">
                ...
                <h4 className="font-semibold text-vitisanus-purple mb-2">Viñedo</h4>
                <p className="text-sm text-vitisanus-purple">Orujo de uva seleccionado</p>
              </div>

              <div className="hidden md:block">
                <svg className="w-8 h-8 text-vitisanus-light-purple" fill="currentColor" viewBox="0 0 24 24">
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <h4 className="font-semibold text-vitisanus-purple mb-2">Molienda</h4>
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <h4 className="font-semibold text-vitisanus-purple mb-2">Harina</h4>
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-10">
            ...
            <p className="text-vitisanus-text max-w-2xl mx-auto">
              Llevá a tu cocina la Harina de Uva Vitisanus. Pedila por WhatsApp y te asesoramos en la mejor presentación para vos.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
              <div className="aspect-square bg-white overflow-hidden flex items-center justify-center">
                <img src="/harina250.png" alt="Paquete 250 g" className="w-full h-full object-contain" />
              </div>
              <div className="p-6 text-center">
                <h4 className="font-chunk text-xl text-vitisanus-purple mb-1">250 g</h4>
                <p className="text-vitisanus-text mb-4">Ideal para probar recetas y sumar antioxidantes.</p>
                <a
            ...
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
              <div className="aspect-square bg-white overflow-hidden flex items-center justify-center">
                <img src="/harina500g.png" alt="Paquete 500 g" className="w-full h-full object-contain" />
              </div>
              <div className="p-6 text-center">
                <h4 className="font-chunk text-xl text-vitisanus-purple mb-1">500 g</h4>
                <p className="text-vitisanus-text mb-4">Para cocinar seguido y explorar más usos.</p>
                <a
                  href="https://wa.me/+5491132736745?text=Hola%20Vitisanus%2C%20quiero%20comprar%20como%20comercio%20(mayorista)"
                  target="_blank" rel="noreferrer"
                  className="btn-effect-3 bg-green-600 hover:bg-green-700 text-white inline-flex items-center gap-2 text-lg px-8 py-4"
            ...
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
              <div className="aspect-square bg-white overflow-hidden flex items-center justify-center">
                <img src="/harina1kg.png" alt="Paquete 1 kg" className="w-full h-full object-contain" />
              </div>
              <div className="p-6 text-center">
                <h4 className="font-chunk text-xl text-vitisanus-purple mb-1">1 kg</h4>
                <p className="text-vitisanus-text mb-10">La opción rendidora para tu despensa.</p>
                <a
                  href="https://wa.me/+5491132736745?text=Hola%20Vitisanus%2C%20quiero%20comprar%20como%20comercio%20(mayorista)"
                  target="_blank" rel="noreferrer"
                  className="btn-effect-3 bg-green-600 hover:bg-green-700 text-white inline-flex items-center gap-2 text-lg px-8 py-4"
        ...
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6 text-lg leading-relaxed text-vitisanus-purple">
              <p>
                En <strong className="text-vitisanus-purple">Finca Dinamia</strong>, transformamos los subproductos del
                viñedo mendocino en ingredientes nutritivos y sostenibles. Nuestra producción responsable aprovecha cada
                parte de la uva, creando valor donde antes había desperdicio.
              </p>
              <p>
                Trabajamos a pequeña escala con un enfoque boutique, garantizando la máxima calidad en cada lote de
                Harina de Uva Vitisanus. Nuestro compromiso con la excelencia y la sustentabilidad nos distingue en el
                mercado de ingredientes naturales.
              </p>
              <p>
                Desde el corazón de Mendoza, llevamos la tradición vitivinícola argentina a tu cocina, ofreciendo
                productos únicos que respetan tanto el medio ambiente como tu salud.
              </p>
            </div>
